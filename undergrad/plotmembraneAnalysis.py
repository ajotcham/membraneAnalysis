...
sigma_list = [mink0_sigma,mink1_sigma,mink2_sigma,mink3_sigma]
    
mink0_var = np.var(mink0)
mink1_var = np.var(mink1)
mink2_var = np.var(mink2)
mink3_var = np.var(mink3)

###Relative Variance = mink[x]_var/absolute value of mean
mink0_mean = np.mean(mink0)
mink1_mean = np.mean(mink1)
mink2_mean = np.mean(mink2)
mink3_mean = np.mean(mink3)

mink0_relvar = mink0_var/mink0_mean
mink1_relvar = mink1_var/mink1_mean
mink2_relvar = mink2_var/mink2_mean
mink3_relvar = mink3_var/mink3_mean

variance_list = [mink0_var,mink1_var,mink2_var,mink3_var]
print("variance: ", variance_list)
print("standard dev: ", sigma_list)