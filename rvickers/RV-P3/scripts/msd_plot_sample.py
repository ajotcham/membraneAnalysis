...
MSDDF_tot['avg'] = MSDDF_tot['sum']/MSDDF_tot['count']
MSDDFz_tot['avg'] = MSDDFz_tot['sum']/MSDDFz_tot['count']
MDDFz_tot['avg'] = MDDFz_tot['sum']/MDDFz_tot['count']

MSDDF_tot.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF_sample.csv')
MSDDFz_tot.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF_z_sample.csv')
MDDFz_tot.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMDDF_z_sample.csv')
