...
for pressure_diff in pressure_diffs:
    molDF = pd.read_csv('./'+stage+'_csv_mols/64x_'+gap_size+'_mols_v_theta.csv',index_col=[0],header=[0,1])
    ...
    MSDDF.to_csv('./'+stage+'_csv_msd/64x_'+gap_size+'_molsMSDDF.csv')
    MSDDFz.to_csv('./'+stage+'_csv_msd/64x_'+gap_size+'_molsMSDDF_z.csv')
    MDDFz.to_csv('./'+stage+'_csv_msd/64x_'+gap_size+'_molsMDDF_z.csv')
