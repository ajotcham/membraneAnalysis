...
MSDDF.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF_'+str(filenum)+'_sample.csv')
MSDDFz.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF_z_'+str(filenum)+'_sample.csv')
MDDFz.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMDDF_z_'+str(filenum)+'_sample.csv')
