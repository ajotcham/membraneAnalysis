...
MSDDF_tot.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF.csv')
MSDDFz_tot.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF_z.csv')
MDDFz_tot.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMDDF_z.csv')
