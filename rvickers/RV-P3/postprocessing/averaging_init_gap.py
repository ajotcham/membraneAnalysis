...
#             print(waterArr[0])  
        ...
        AVGgapDensitySeriesDF.index.names = ['Distance in z (Å)']   
        ...
        gapDensitySeriesDF.to_csv('./csv/pagap'+gap_size+'_nve'+pressure_diff+'_density_gap.csv')
        AVGgapDensitySeriesDF.to_csv('./csv/pagap'+gap_size+'_nve'+pressure_diff+'_density_gap_avg.csv')

        gapvxSeriesDF.to_csv('./csv/pagap'+gap_size+'_nve'+pressure_diff+'_vx_gap.csv')
        AVGgapvxSeriesDF.to_csv('./csv/pagap'+gap_size+'_nve'+pressure_diff+'_vx_gap_avg.csv')

        gapvySeriesDF.to_csv('./csv/pagap'+gap_size+'_nve'+pressure_diff+'_vy_gap.csv')
