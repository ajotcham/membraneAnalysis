...
for pressure_diff in pressure_diffs:
    ...
    r_sample_df = pd.read_csv('./random_samples_all/pa_gap{}_nve{}_dy.csv'.format(gap_size,pressure_diff),index_col=[0])
    rt_sample_df = pd.read_csv('./random_samples_all/pa_gap{}_nve{}_rt.csv'.format(gap_size,pressure_diff),index_col=[0])
    mols = []
    dfs = []
    ...
    trajectoryDF.to_csv('./sampled_trajs_all/pa_gap{}_nve{}_dy.csv'.format(gap_size,pressure_diff))
    ...
    trajectoryDF1.to_csv('./sampled_trajs_all/pa_gap{}_nve{}_rt.csv'.format(gap_size,pressure_diff))