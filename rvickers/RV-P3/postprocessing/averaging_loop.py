...
for gap_size in gap_sizes:
    ...
    for pressure_diff in pressure_diffs:
        ...
        existing_pressure_csv = "./"+stage+"_csv/64x_"+gap_size+"_pressure.csv"
        existing_density_csv = "./"+stage+"_csv/64x_"+gap_size+"_density.csv"
        existing_velocity_csv = "./"+stage+"_csv/64x_"+gap_size+"_vz.csv"
        ...
        existing_pressure_gap_csv = "./"+stage+"_csv/64x_"+gap_size+"_pressure_gap.csv"
        existing_count_gap_csv = "./"+stage+"_csv/64x_"+gap_size+"_count_gap.csv"
        existing_velocity_gap_csv = "./"+stage+"_csv/64x_"+gap_size+"_vz_gap.csv"
        ...
        existing_pressure_res_csv = "./"+stage+"_csv/64x_"+gap_size+"_res_pressures.csv"
        existing_count_res_csv = "./"+stage+"_csv/64x_"+gap_size+"_res_counts.csv"
        existing_velocity_res_csv = "./"+stage+"_csv/64x_"+gap_size+"_res_velocties.csv"
...
#             print(waterArr[0])  
        ...
        pressureDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_pressure.csv')
        AVGpressureSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_pressure_avg.csv')
        
        densityDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_density.csv')
        AVGdensitySeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_density_avg.csv')

        vzDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_vz.csv')
        AVGvzSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_vz_avg.csv')
        vzGapDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_vz_gap.csv')
        AVGgapvzSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_vz_gap_avg.csv')

        pressureGapDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_pressure_gap.csv')
        AVGgapPressureSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_pressure_gap_avg.csv')
        countGapDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_count_gap.csv')
        AVGgapCountSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_count_gap_avg.csv')
        pressureResDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_res_pressures.csv')
        print(pressureResDF.mean(axis=1))
        print(pressureResDF.std(axis=1))
        vzResDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_res_velocties.csv')
        print(vzResDF.mean(axis=1))
        print(vzResDF.std(axis=1))
        countResDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_res_counts.csv')
