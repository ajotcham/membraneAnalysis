...
for pressure_diff in pressure_diffs:
    existingMolDF = pd.read_csv('./'+stage+'_csv_mols_v2/64x_'+gap_size+'_mols_v_theta_'+filenumber+'.csv',index_col=[0],header=[0,1])
...
#     print(allWaterArr)
    ...
    combinedMolDF.to_csv('./'+stage+'_csv_mols_v2/64x_'+gap_size+'_mols_v_theta_'+filenumber+'.csv')
