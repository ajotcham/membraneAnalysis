...
if gap_size == '05':
    averaging_window = (0,20000000)
elif gap_size == '06':
    averaging_window = (4000000,20000000)
elif gap_size == '10':
    averaging_window = (3000000,20000000)
elif gap_size == '20':
    averaging_window = (3000000,20000000)
elif gap_size == '30':
    averaging_window = (3000000,20000000)
...
for pressure_diff in pressure_diffs:
    ...
    # SDDF.to_csv('./csv/pagap'+gap_size+'_nve'+pressure_diff+'_molsSDDF.csv')
