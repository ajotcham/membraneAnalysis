...
molDF = molDF[molDF.iloc[:,molDF.columns.get_level_values(1)=='z'].max(axis=1)>75]
...
np.savetxt('./'+stage+'_msd_samples/permed_'+str(filenum)+'.csv',molDF.index.values)
...
MSDDF.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF_permed_'+str(filenum)+'.csv')
MSDDFz.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMSDDF_z_permed_'+str(filenum)+'.csv')
MDDFz.to_csv('./'+stage+'_msd/64x_'+gap_size+'_molsMDDF_z_permed_'+str(filenum)+'.csv')
