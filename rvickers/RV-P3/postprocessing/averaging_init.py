...
#             print(waterArr[0])  
        ...
        pressureSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_pressure.csv')
        ...
        densitySeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_density.csv')
        ...
        vzSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_vz.csv')
        ...
        gapvzSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_vz_gap.csv')
        ...
        gapPressureSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_pressure_gap.csv')
        ...
        gapCountSeriesDF.to_csv('./'+stage+'_csv/64x_'+gap_size+'_count_gap.csv')
        ...
        resPressures.to_csv('./'+stage+'_csv/64x_'+gap_size+'_res_pressures.csv')
        print(resPressures.mean(axis=1))
        print(resPressures.std(axis=1))
        resVelocities.to_csv('./'+stage+'_csv/64x_'+gap_size+'_res_velocties.csv')
        print(resVelocities.mean(axis=1))
        print(resVelocities.std(axis=1))
        resCounts.to_csv('./'+stage+'_csv/64x_'+gap_size+'_res_counts.csv')
